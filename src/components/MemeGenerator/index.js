...
class MemeGenerator extends Component {
  ...
  render = () => {
    const {backgroundImageUrl, topText, bottonText, activeFontSizeId} =
      this.state

    return (
      <MemeContainer data-testid="name" backgroundImage={backgroundImageUrl}>
